  ...
  return (
    <>
      ...
      <Button
        ...
        className={`fixed bottom-8 right-8 z-50 w-16 h-16 rounded-full gradient-button shadow-2xl shadow-primary/30 hover:scale-110 transition-all duration-300 ${
      ...
      {/* Chat Window */}
      {isOpen && (
        <Card className="fixed bottom-28 right-8 z-50 w-96 max-w-[calc(100vw-4rem)] h-[500px] bg-card border-border shadow-2xl shadow-primary/20 flex flex-col overflow-hidden animate-scale-in">
          {/* Header */}
