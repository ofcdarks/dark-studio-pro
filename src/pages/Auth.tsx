      ...
      >
        ...
        >
          ...
          <div className="flex flex-col items-center mb-4 relative">
            ...
            <span className="text-2xl font-bold text-primary">CORE</span>
            
            <p className="text-sm text-foreground mt-2 text-center">
              Acesso ao Núcleo Privado
            </p>
            <p className="text-xs text-muted-foreground mt-1 text-center">
              Ferramentas para criadores de canais dark em escala
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-3 relative">
            ...
            {/* Recover access link */}
            {isLogin && (
              <button type="button" className="text-primary text-sm hover:underline text-left">
