...
import { ArrowLeft, Clock, Calendar, User, Share2, Wrench, Check, X } from "lucide-react";
    ...
    <>
      ...
      <div className="min-h-screen bg-background">
        ...
        <article className="container mx-auto px-4 py-12 max-w-4xl">
          ...
          <div className="aspect-video bg-gradient-to-br from-emerald-500/20 to-primary/5 rounded-2xl mb-8 flex items-center justify-center border border-border/50">
            <Wrench className="w-24 h-24 text-emerald-500/40" />
          </div>
          ...
          <div className="mt-12">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <Link to="/blog/roteiros-virais-ia" className="p-4 bg-card rounded-xl border border-border/50 hover:border-primary/50 transition-colors">
                <h4 className="font-semibold mb-2">Roteiros Virais com IA</h4>
                <p className="text-sm text-muted-foreground">Técnicas para roteiros que convertem</p>
              </Link>
            </div>
          </div>
        </article>
