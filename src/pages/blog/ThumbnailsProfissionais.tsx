...
import { ArrowLeft, Clock, Calendar, User, Share2, Image } from "lucide-react";
    ...
    <>
      ...
      <div className="min-h-screen bg-background">
        ...
        <article className="container mx-auto px-4 py-12 max-w-4xl">
          ...
          <div className="aspect-video bg-gradient-to-br from-orange-500/20 to-primary/5 rounded-2xl mb-8 flex items-center justify-center border border-border/50">
            <Image className="w-24 h-24 text-orange-500/40" />
          </div>
