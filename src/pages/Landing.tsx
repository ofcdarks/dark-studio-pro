  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden relative">
      ...
      <section className="pt-28 md:pt-36 pb-16 md:pb-24 px-4 relative overflow-hidden min-h-[90vh] flex items-center">
        ...
        {/* Scroll indicator and Marquee inside hero */}
        <div className="w-full flex flex-col items-center mt-8 md:mt-12">
          ...
          <div className="relative overflow-hidden py-3 md:py-4 bg-gradient-to-r from-primary via-amber-500 to-primary w-screen mt-6">
            {/* Shimmer overlay */}
